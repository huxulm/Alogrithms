...
import (
	...
	"github.com/huxulm/algorithms/structure/hashmap"
)
...
func TestBitwiseOperate(t *testing.T) {
	var val uint64 = 0x8c093f7e9fccbf69
	fmt.Printf("val: %16x\n", val)
	val2 := val >> 16
	fmt.Printf("val2: %16x\n", val2)
	fmt.Printf("val ^ (val >> 16): %16x\n", val^val2)
	fmt.Printf("hash: %16x\n", (val^val2)&1<<10)
}
